 ...
 function Check() 
{
	...
	function Show_all_Cabinets (Number_Open_Tab) 
{
			 ...
			 var Tabl="";	
						...
						reqest.onreadystatechange = function () 
						{
							if(reqest.readyState ==4&&reqest.status==200)
								{					
									otv=reqest.responseText;		
									var dlina=otv.length;	
									var Zam4=otv.split('\"][\"');			
									var zz=Zam4;
									for(var tt=0;tt<zz.length;tt++)
										{
		...
		reqest.open('POST', '../PHP/Read_Cabinety.php',false);
